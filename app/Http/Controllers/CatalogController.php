...
class CatalogController extends Controller
{
  private $arrayPeliculas = array(
      ...
      array(
        ...
        'year' => '1974',
        'director' => 'Francis Ford Coppola',
        'poster' => 'https://images-na.ssl-images-amazon.com/images/I/512pMFGe6yL._SY445_.jpg',
        'rented' => false,
      ...
      array(
        ...
        'poster' => 'https://bucket2.glanacion.com/anexos/fotos/cartelera/la-lista-de-schindler-c_9017_poster2.jpg',
        'rented' => false,
      ...
      array(
        ...
        'poster' => 'http://es.web.img3.acsta.net/c_215_290/medias/nmedia/18/74/26/88/20133359.jpg',
        'rented' => true,
      ...
      array(
        ...
        'poster' => 'https://cloud10.todocoleccion.online/cine-peliculas-dvd/tc/2018/02/28/12/113658163.jpg',
        'rented' => false,
      ...
      array(
        ...
        'year' => '1999',
        'director' => 'David Fincher',
        'poster' => 'https://unlibroparaestanoche.files.wordpress.com/2014/08/el-club-de-la-lucha-poster.jpg',
        'rented' => true,
    ...
    public function getShow($id){
      return view('catalog.show', array('idPeliculas'=> $this->arrayPeliculas[$id]));
    }
